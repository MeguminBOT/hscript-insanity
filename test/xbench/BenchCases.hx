...
class BenchCases {
	...
	public static function all(n:Int):Array<Case> {
		...
		return [
			...
			{n: "noCall", t: "core", i: N, x: "0", s: 'var i = 0; var s = 0; while (i < $N) { s = s; i += 1; } s;'},
			{n: "loopPlain", t: "core", i: N, x: N, s: 'var i = 0; var s = 0; while (i < $N) { i += 1; s += 1; } s;'},
			...
			{n: "postIncr", t: "core", i: N, x: N, s: 'var i = 0; var n = 0; while (n < $N) { i++; n += 1; } i;'},
			{n: "arith", t: "core", i: N, x: Std.string(2 * n - 3), s: 'var x = 0; var i = 0; while (i < $N) { x = i * 2 - 1; i += 1; } x;'},
			{n: "locals", t: "core", i: N, x: "5", s: 'var a = 1; var b = 2; var c = 3; var i = 0; while (i < $N) { a = b + c; i += 1; } a;'},
			{n: "blocks", t: "core", i: N, x: last, s: 'var i = 0; var s = 0; while (i < $N) { { var t = i; s = t; } i += 1; } s;'},
			{n: "field", t: "core", i: N, x: "1", s: 'var o = {a: 1, b: 2}; var i = 0; var s = 0; while (i < $N) { s = o.a; i += 1; } s;'},
			{n: "fieldSet", t: "core", i: N, x: last, s: 'var o = {a: 1}; var i = 0; while (i < $N) { o.a = i; i += 1; } o.a;'},
			{n: "method", t: "core", i: N, x: "0", s: 'var a = [1]; var i = 0; var s = 0; while (i < $N) { s = a.indexOf(1); i += 1; } s;'},
			{n: "index", t: "core", i: N, x: "2", s: 'var a = [1, 2, 3]; var i = 0; var s = 0; while (i < $N) { s = a[1]; i += 1; } s;'},
			{n: "indexSet", t: "core", i: N, x: last, s: 'var a = [1, 2, 3]; var i = 0; while (i < $N) { a[0] = i; i += 1; } a[0];'},
			{n: "not", t: "core", i: N, x: "1", s: 'var b = false; var i = 0; var s = 0; while (i < $N) { if (!b) s = 1; i += 1; } s;'},
			{n: "neg", t: "core", i: N, x: "-5", s: 'var x = 5; var i = 0; var s = 0; while (i < $N) { s = -x; i += 1; } s;'},
			{n: "call0", t: "core", i: N, x: "1", s: 'function f() return 1; var i = 0; var s = 0; while (i < $N) { s = f(); i += 1; } s;'},
			{n: "call1", t: "core", i: N, x: "7", s: 'function f(a) return a; var i = 0; var s = 0; while (i < $N) { s = f(7); i += 1; } s;'},
			{
				n: "call3",
				t: "core",
				i: N,
			...
			{n: "arrayDecl", t: "core", i: N, x: "3", s: 'var i = 0; var n = 0; while (i < $N) { var a = [1, 2, 3]; n = a.length; i += 1; } n;'},
			{n: "strConcat", t: "core", i: N, x: 'x$last', s: 'var s = \'\'; var i = 0; while (i < $N) { s = \'x\' + i; i += 1; } s;'},
			{
				n: "ternary",
				t: "core",
				i: N,
			...
			{n: "tryCatch", t: "ext", i: N, x: "1", s: 'var s = 0; var i = 0; while (i < $N) { try { throw \'e\'; } catch (e:Dynamic) { s = 1; } i += 1; } s;'},
			...
			{n: "strInterp", t: "ext", i: N, x: "v5", s: 'var n = 5; var s = \'\'; var i = 0; while (i < $N) { s = \'v$$n\'; i += 1; } s;'},
			{
				n: "mapLiteral",
				t: "ext",
				i: N,
			...
			{n: "varTyped", t: "ext", i: N, x: last, s: 'var i = 0; var x:Int = 0; while (i < $N) { x = i; i += 1; } x;'},
			{n: "fnTyped", t: "ext", i: N, x: "7", s: 'function f(a:Int):Int return a; var i = 0; var s = 0; while (i < $N) { s = f(7); i += 1; } s;'},

			// --- ext: script-declared classes, which only some libraries have at all ---
			{n: "classNew", t: "ext", i: N, x: "0", s: 'class B { public function new() {} }\nvar i = 0; while (i < $N) { new B(); i += 1; } 0;'},
			{
				n: "classCall",
				t: "ext",
				i: N,
